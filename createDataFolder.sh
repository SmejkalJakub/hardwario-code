...
then
    ...
    7z x Windows/data/tower/toolchain/jlink.exe -oWindows/data/tower/toolchain/SEGGER/JLink -r -y
    ...
    7z x Windows/data/tower/toolchain/gcc.zip -oWindows/data/tower/toolchain/ -r -y
    ...
    7z x Windows/data/tower/toolchain/ninja.zip -oWindows/data/tower/toolchain/ -r -y
    ...
    7z x Windows/data/tower/toolchain/git.7z.exe -oWindows/data/tower/toolchain/git/ -r -y
    ...
    rm -rf Windows/data/tower/toolchain/*.zip
    rm -rf Windows/data/tower/toolchain/*.7z.exe
    rm -rf Windows/data/tower/toolchain/*.exe
    rm -rf Windows/data/tower/toolchain/.gitignore
fi